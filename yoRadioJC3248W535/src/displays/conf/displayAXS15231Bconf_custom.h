...
const ScrollConfig apSettConf    PROGMEM = {{ TFT_FRAMEWDT, 320-TFT_FRAMEWDT-16, 2, WA_LEFT }, 140, false, MAX_WIDTH, 3000, 3, 30 };
const ScrollConfig weatherConf   PROGMEM = {{ TFT_FRAMEWDT, 121, 2, WA_CENTER }, 140, false, MAX_WIDTH, 5000, 2, 30 };
const ScrollConfig namedayConf   PROGMEM = {{ TFT_FRAMEWDT, 205, 2, WA_LEFT }, 80, true, 161, 0, 1, 20 };
...
const WidgetConfig bootstrConf   PROGMEM = {0, 265, 2, WA_CENTER};
const WidgetConfig bitrateConf   PROGMEM = {TFT_FRAMEWDT, 145, 1, WA_RIGHT};
...
const WidgetConfig bootWdtConf   PROGMEM = {0, 293, 2, WA_CENTER};
const ProgressConfig bootPrgConf PROGMEM = {0, 14, 4};
...
const MoveConfig weatherMove   PROGMEM = {10, 121, MAX_WIDTH}; // Ha a VU ki van kapcsolva (szélesített pozíció)
const MoveConfig weatherMoveVU PROGMEM = {10, 121, MAX_WIDTH}; // Az időjárás widget pozíciója.
